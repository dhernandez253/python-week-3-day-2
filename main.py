...
name_last="Oliver"
# email@address
email_address="Bakimebro68@gmail.com"
# percent%
percent=70
# variable#name
variable_name="MK"
...
#i can also find the data type for the age variables
print(type(moms_age))
print(type(dads_age))


#floats are very similar
weight=200.45
height=1.75
print(weight)
print(height)
...
age_of_hancockHighSchool=int(input("What is the age of hancock high school?"))

print(f"Your age is {age} and the age of hancock is.{age_of_hancockHighSchool}. Your ages combined are {age+age_of_hancockHighSchool}")
